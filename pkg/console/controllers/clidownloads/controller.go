...
func NewCLIDownloadsSyncController(
	...
	configNameFilter := controllersutil.NamesFilter(api.ConfigResourceName)
	targetNameFilter := controllersutil.NamesFilter(api.OpenShiftConsoleName)
...
func (c *CLIDownloadsSyncController) Sync(ctx context.Context, controllerContext factory.SyncContext) error {
	...
	_, ocCLIDownloadsErrReason, ocCLIDownloadsErr := ApplyCLIDownloads(c.consoleCliDownloadsClient, ocConsoleCLIDownloads, ctx)
	...
	_, odoCLIDownloadsErrReason, odoCLIDownloadsErr := ApplyCLIDownloads(c.consoleCliDownloadsClient, ODOConsoleCLIDownloads(), ctx)
